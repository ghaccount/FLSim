...
class LocalOptimizerProximal(LocalOptimizer, torch.optim.SGD):
    def __init__(
        ...
        **kwargs,
        ...
        self.init_param_group = self.get_param_group(self.init_model)
    ...
    @torch.no_grad()
    # pyre-ignore[14]
    def step(self, init_model: IFLModel, closure=None):
        """
        ...
        grad_norm_sq = 0
        for local_group, global_group in zip(self.param_groups, self.init_param_group):
